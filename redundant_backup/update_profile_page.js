...
/**
 * @description 加载个人资料页面的CSS样式
 */
function loadProfileStyles() {
    console.log('正在加载个人资料页样式...');
    
    // 创建link元素引用CSS文件
    const styleLink = document.createElement('link');
    styleLink.rel = 'stylesheet';
    styleLink.href = 'update_profile_style.css';
    ...
    styleLink.onload = function() {
        console.log('个人资料页样式加载完成！');
    };
    
    styleLink.onerror = function() {
        console.error('个人资料页样式加载失败！');
    };
}
...
function updateProfilePage() {
    ...
    // 更新页面内容
    updateProfileContent(profileScreen, navBottom);
}

/**
 * @description 更新个人资料页面的内容
 * @param {HTMLElement} profileScreen - 个人资料页面元素
 * @param {HTMLElement} navBottom - 底部导航栏元素
 */
function updateProfileContent(profileScreen, navBottom) {
    // 第一阶段：先只更新可滚动内容区域
    ...
    // 恢复导航栏
    if (navBottom) {
        profileScreen.appendChild(navBottom);
    }
